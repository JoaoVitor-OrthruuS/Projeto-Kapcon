from tkinter import *
class Principal:
    def __init__(self, master=None): #cria o método inicial que será filho da classe principal
        self.fontePadrao = ("Arial", 10)
        self.Container1 = Frame(master) #container pai com um frame
        ...
        self.Container3 = Frame(master) #cria um container para label e text field para senha
        ...
        self.nome = Entry(self.Container2) #utiliza o método entry (input) para receber os dados via teclado
...
tela["bg"] = "light green"
tela.geometry("400x250")#Define o tamanho da tela
Principal(tela)#instancia da classe principal, passando a variável tela como parâmetro
tela.mainloop()#método que carrega a tela para que os eventos ocorram